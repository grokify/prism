...
| `--prism-ui-js` | | Path to @grokify/prism UI bundle for Lit components |
| `--aggregation` | `min` | Maturity aggregation method: `min` or `avg` |
| `--hide-generated-by` | `false` | Hide "Generated by PRISM" footer |
